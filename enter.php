...
<form action="faculty.php" method="post">
    ...
    <input type="text" name="first_name" id="first-name" placeholder="eg.Manav" />
    <label for="last-name">Last Name : </label>
    <input type="text" name="last_name" id="last-name" placeholder="eg.Motwani"/>
    ...
    <input type="Phone" name="ph" id="Phno">
    <label for="department_id">Department Id : </label>
    <input type="text" name="department_id" id="department_id" placeholder="eg.12" />
