...
<div class="push">
    <h3>Enter your records</h3>
    <button type="button" class="btn btn-dark"><a href="student_insert.php">click here</a></button>
</div>
<div class="push">
    <h3>See your records</h3>
    <button type="button" class="btn btn-dark"><a href="student_extract.php">click here</a></button>
</div>
<div class="push">
    <h3>delete your records</h3>
    <button type="button" class="btn btn-dark"><a href="student_delete.php">click here</a></button>
</div>
<footer>
